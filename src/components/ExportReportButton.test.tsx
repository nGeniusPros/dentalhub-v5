...
describe('ExportReportButton', () => {
  ...
  it('should pass data and type props to the export dialog', async () => {
    const mockData = [{ id: '1', firstName: 'Test', lastName: 'Staff', email: 'test@example.com', phone: '1234567890', role: 'admin', department: 'IT', status: 'active' as const, startDate: '2024-01-01', salary: 100000, payFrequency: 'monthly' as const }];
    ...
    expect(screen.queryByText('Error: No data available for CSV export')).toBeNull();
  });
});