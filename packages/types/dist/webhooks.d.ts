...
export type RetellWebhookEvent = RetellCallStartedEvent | RetellCallEndedEvent | RetellTranscriptionEvent | RetellRecordingEvent;
...
export type SikkaWebhookEvent = SikkaEligibilityVerifiedEvent | SikkaClaimStatusEvent | SikkaPreAuthStatusEvent | SikkaBenefitsUpdateEvent;
...
export type OpenAIWebhookEvent = OpenAICompletionEvent | OpenAIErrorEvent | OpenAIModeratedEvent;
export type WebhookEvent = RetellWebhookEvent | SikkaWebhookEvent | OpenAIWebhookEvent;
