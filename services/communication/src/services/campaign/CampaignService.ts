...
export class CampaignService {
  ...
  async updateCampaignMetrics(id: string, metrics: Partial<Campaign['metrics']>): Promise<Campaign> {
  ...
  private calculateCampaignStatus(metrics: Campaign['metrics']): CampaignStatus {
