...
describe('Sikka Integration', () => {
    ...
    describe('verifyInsurance', () => {
        ...
        it('should handle verification failure', async () => {
            ...
            await expect(verifyInsurance(mockData)).rejects.toThrow(SikkaIntegrationError);
        });
    });
    describe('checkEligibility', () => {
        ...
        it('should handle eligibility check failure', async () => {
            ...
            await expect(checkEligibility(mockData)).rejects.toThrow(SikkaIntegrationError);
        });
    });
    describe('verifyBenefits', () => {
        ...
        it('should handle benefits verification failure', async () => {
            ...
            await expect(verifyBenefits(mockData)).rejects.toThrow(SikkaIntegrationError);
        });
    });
    describe('processClaim', () => {
        ...
        it('should handle claim submission failure', async () => {
            ...
            await expect(processClaim(mockData)).rejects.toThrow(SikkaIntegrationError);
        });
