...
let OperationsAgent = (() => {
    var _a;
    let _classSuper = BaseAgent;
    let _instanceExtraInitializers = [];
    let _analyzeEfficiency_decorators;
    return _a = class OperationsAgent extends _classSuper {
            constructor(metricsRepo, kpiEngine, scheduler) {
                super();
        ...
        (() => {
            ...
            _analyzeEfficiency_decorators = [trackPerformance];
            __esDecorate(_a, null, _analyzeEfficiency_decorators, { kind: "method", name: "analyzeEfficiency", static: false, private: false, access: { has: obj => "analyzeEfficiency" in obj, get: obj => obj.analyzeEfficiency }, metadata: _metadata }, null, _instanceExtraInitializers);
