 ...
 */
export async function syncProcedureCodes(sikkaProcedureCodes, practiceId) {
 ...
 */
async function syncProcedureCode(sikkaProcedureCode, practiceId) {
    try {
        ...
        await db.procedure_codes.upsert({
            ...
            update: {
                ...
                effect_on_patient_balance: sikkaProcedureCode.procedure_code_effect_on_patient_balance,
                effect_on_provider_production: sikkaProcedureCode.procedure_code_effect_on_provider_production,
                effect_on_provider_collection: sikkaProcedureCode.procedure_code_effect_on_provider_collection,
        ...
        console.error(`Error syncing procedure code ${sikkaProcedureCode.procedure_code}:`, error);
        throw error;
    }
}
/**
    ...
    */
export async function updateProcedureCodeFee(practiceId, procedureCode, feeAmount, effectiveDate) {
    ...
    if (!procedure) {
        throw new Error(`Procedure code ${procedureCode} not found for practice ${practiceId}`);
    }
...
/**
    ...
    */
export async function getPracticeProcedureCodes(practiceId) {
