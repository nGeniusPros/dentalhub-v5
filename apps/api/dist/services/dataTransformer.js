...
export function transformPatientData(patient) {
    return {
        ...
        medical_history: {
            ...
            insurance: {
                primary_insurance_company_id: patient.primary_insurance_company_id || null,
                ...
                primary_medical_insurance_id: patient.primary_medical_insurance_id || null,
                primary_medical_relationship: patient.primary_medical_relationship || null,
                primary_medical_subscriber_id: patient.primary_medical_subscriber_id || null,
            },
            referrals: {
