...
export class MonitoringService {
    // Log HTTP request
    static logRequest(method, route, statusCode, duration) {
    ...
    static logEdgeFunction(functionName, status, duration) {
    ...
    // Log error
    static logError(error, code, context) {
        logger.error('Error', {
