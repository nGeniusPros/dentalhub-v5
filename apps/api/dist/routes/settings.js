...
router.get('/practice/:key', asyncHandler(async (req, res) => {
...
router.put('/practice/:key', asyncHandler(async (req, res) => {
    const validationResult = practiceSettingKeySchema.safeParse(req.params);
...
router.get('/integrations/:key', asyncHandler(async (req, res) => {
