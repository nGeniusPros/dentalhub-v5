...
router.post('/courses', asyncHandler(async (req, res) => {
    ...
    const { title, description, category, duration, prerequisites, learning_objectives, thumbnail_url } = validationResult.data;
    const { data: course, error } = await req.supabase
        .from('courses')
        .insert({
        title,
...
router.put('/courses/:id', asyncHandler(async (req, res) => {
    ...
    const { id } = validationResult.data;
    const { title, description, status, category, duration, prerequisites, learning_objectives, thumbnail_url } = updateValidationResult.data;
    const updates = {
        title,
        description,
        category,
...
router.post('/modules/:id/content', asyncHandler(async (req, res) => {
    const validationResult = courseIdSchema.safeParse(req.params);
...
router.get('/certifications/user/:id', asyncHandler(async (req, res) => {
...
router.put('/certifications/:id/status', asyncHandler(async (req, res) => {
    const validationResult = certificationIdSchema.safeParse(req.params);
