...
router.post('/', asyncHandler(async (req, res) => {
    ...
    const { entry_date, category, amount, source, reference_id, reference_type, notes } = validationResult.data;
...
// Create payment plan
router.post('/payment-plans', asyncHandler(async (req, res) => {
    ...
    const { patient_id, total_amount, installment_amount, frequency, start_date, end_date, notes } = validationResult.data;
...
// Update payment plan
router.put('/payment-plans/:id', asyncHandler(async (req, res) => {
    ...
    const { remaining_amount, next_payment_date, status, notes } = updateValidationResult.data;
    const { data: plan, error } = await req.supabase
        .from('payment_plans')
        .update({
        remaining_amount,
