...
const getProvidersHandler = async (req, res) => {
    try {
        ...
        const providers = await getPaginatedData(requestKey, env.SIKKA_P1_PRACTICE_ID, 'providers', 'provider_id,practice_id,provider_type,firstname,lastname,national_provider_identifier,status,is_user');
