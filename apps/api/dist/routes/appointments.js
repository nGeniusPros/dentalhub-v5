...
router.post('/', asyncHandler(async (req, res) => {
    ...
    const { patient_id, provider_id, type, start_time, end_time, duration, notes, resources, reminders } = validationResult.data;
    const appointmentService = new AppointmentService(req.supabase);
...
router.put('/:id', asyncHandler(async (req, res) => {
    ...
    const { id } = req.params;
    const { patient_id, provider_id, type, status, start_time, end_time, duration, notes, resources, reminders } = validationResult.data;
    const appointmentService = new AppointmentService(req.supabase);
