...
function isInsuranceVerificationRequest(data) {
...
function isEligibilityRequest(data) {
    return (typeof data === 'object' &&
        data !== null &&
        typeof data.patientId === 'string' &&
        typeof data.serviceDate === 'string' &&
        Array.isArray(data.serviceTypes) &&
        data.serviceTypes.every((type) => typeof type === 'string'));
}
function isBenefitsVerificationRequest(data) {
    return (typeof data === 'object' &&
        data !== null &&
        typeof data.patientId === 'string' &&
        Array.isArray(data.procedureCodes) &&
        data.procedureCodes.every((code) => typeof code === 'string') &&
        typeof data.serviceDate === 'string');
}
function isClaimRequest(data) {
    return (typeof data === 'object' &&
        data !== null &&
        typeof data.patientId === 'string' &&
        ...
        data.claimDetails.procedures.every((proc) => typeof proc === 'object' &&
            proc !== null &&
            typeof proc.code === 'string' &&
            typeof proc.fee === 'number' &&
            Array.isArray(proc.diagnosis) &&
            proc.diagnosis.every((d) => typeof d === 'string')) &&
        Array.isArray(data.claimDetails.diagnosisCodes) &&
        data.claimDetails.diagnosisCodes.every((code) => typeof code === 'string') &&
