...
import { SikkaErrorCode } from '../../../../frontend/src/lib/ai-agents/types/errors';
/**
 ...
 */
export function createErrorMessage(error, defaultMessage) {
 ...
 */
export function logSikkaError(error, details, agentType = DentalAgentType.SIKKA) {
    console.error({
        timestamp: new Date().toISOString(),
        type: error.name,
