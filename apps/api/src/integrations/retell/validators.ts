...
function isVoiceCallRequest(data: any): data is VoiceCallRequest {
  return (
    ...
    ["appointment_reminder", "follow_up", "billing", "custom"].includes(
      data.purpose,
    ) &&
    (data.customScript === undefined ||
      typeof data.customScript === "string") &&
    (data.language === undefined || typeof data.language === "string") &&
    (data.priority === undefined ||
      ["high", "normal", "low"].includes(data.priority))
  );
}
