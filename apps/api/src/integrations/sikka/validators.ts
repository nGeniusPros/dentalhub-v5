...
function isInsuranceVerificationRequest(
  data: any,
): data is InsuranceVerificationRequest {
  return (
    typeof data === "object" &&
    data !== null &&
    ...
    (data.insuranceInfo.groupNumber === undefined ||
      typeof data.insuranceInfo.groupNumber === "string")
  );
}
...
function isBenefitsVerificationRequest(
  data: any,
): data is BenefitsVerificationRequest {
  return (
    typeof data === "object" &&
    data !== null &&
    typeof data.patientId === "string" &&
...
function isClaimRequest(data: any): data is ClaimRequest {
  return (
    ...
    data.claimDetails.procedures.every(
      (proc: any) =>
        typeof proc === "object" &&
        proc !== null &&
    ...
    data.claimDetails.diagnosisCodes.every(
...
export const validateInsuranceRequest = createValidator(
  isInsuranceVerificationRequest,
);
export const validateEligibilityRequest = createValidator(isEligibilityRequest);
export const validateBenefitsRequest = createValidator(
  isBenefitsVerificationRequest,
);
