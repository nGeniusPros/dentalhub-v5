...
import { AgentConfig } from "@dental/core/ai/types";
...
describe("OpenAIService", () => {
  ...
  describe("createChatCompletion", () => {
    it("should create a chat completion successfully", async () => {
      ...
      const result = await service.createChatCompletion(
        ...
        { patientId: "123", sessionId: "456", metadata: {} },
      );
  ...
  describe("Thread Management", () => {
    ...
    it("should add a message to thread successfully", async () => {
      ...
      const result = await service.addMessageToThread(
        "thread_123",
        "Test message",
      );
    ...
    it("should handle failed runs", async () => {
      ...
      await expect(
        service.runAssistant("thread_123", "asst_123"),
