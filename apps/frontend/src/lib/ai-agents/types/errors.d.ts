...
export declare class AgentError extends Error {
    ...
    constructor(message: string, agentType: DentalAgentType, code: string, retryable: boolean, underlying?: Error | undefined);
}
export declare class OpenAIError extends AgentError {
    status: number;
    constructor(message: string, agentType: DentalAgentType, code: OpenAIErrorCode, retryable: boolean, status: number, underlying?: Error);
}
...
export declare class SikkaApiError extends AgentError {
    ...
    constructor(message: string, agentType: DentalAgentType, code: SikkaErrorCode, retryable: boolean, details: SikkaErrorDetails, underlying?: Error);
}
export declare class SikkaAuthenticationError extends SikkaApiError {
    constructor(message: string, agentType: DentalAgentType, details: SikkaErrorDetails, underlying?: Error);
}
...
export declare class RateLimitError extends AgentError {
    ...
    constructor(agentType: DentalAgentType, retryAfter?: number | undefined, message?: string);
}
export declare class ValidationError extends AgentError {
    field?: string | undefined;
    constructor(message: string, agentType: DentalAgentType, field?: string | undefined);
}
export declare function isRetryableError(error: Error): boolean;
export declare function convertOpenAIError(error: any, agentType: DentalAgentType): AgentError;
