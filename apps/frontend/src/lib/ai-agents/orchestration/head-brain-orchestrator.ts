...
import { HEAD_BRAIN_CONSULTANT_PROMPT, HEAD_BRAIN_METRICS } from '../prompts/head-brain-consultant';
...
export class HeadBrainOrchestrator {
  ...
  private async identifyRequiredAgents(query: string): Promise<DentalAgentType[]> {
