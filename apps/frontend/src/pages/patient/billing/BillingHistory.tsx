        ...
        >
          <div className="mb-6 p-4 bg-ngenius-gray-50 rounded-lg">
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-3xl font-bold text-ngenius-primary">
                  $350.00
                </p>
              </div>
              <div className="text-right">
                ...
                <p className="text-lg font-semibold text-ngenius-gray-900">
                  Mar 15, 2024
                </p>
              </div>
            </div>
          ...
          <div className="space-y-4">
            {transactions.map((transaction, index) => (
              <div
                key={index}
                className="flex items-center justify-between p-4 bg-ngenius-gray-50 rounded-lg"
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="font-medium text-ngenius-gray-900">
