...
const Dashboard = () => {
  ...
  const items = dashboardItems[role as keyof typeof dashboardItems] || [];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {items.map((item, index) => (
            <motion.div
              ...
              className="bg-white/80 backdrop-blur-xl p-6 rounded-xl shadow-lg border border-[#1B2B85]/10 cursor-pointer hover:shadow-xl transition-shadow"
            >
              <div className="flex items-center space-x-4">
                <div className="p-3 rounded-lg bg-gradient-to-r from-[#1B2B85] to-[#40E0D0]">
