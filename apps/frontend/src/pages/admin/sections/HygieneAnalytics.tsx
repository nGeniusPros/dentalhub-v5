...
export const HygieneAnalytics = () => {
  // TODO: Connect this component to the backend API to fetch hygiene analytics
  const hygieneData = [
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        {[
          { label: 'Monthly Cleanings', value: '172', trend: '+8%', icon: Icons.Brush },
          { label: 'Recare Rate', value: '85%', trend: '+5%', icon: Icons.CalendarCheck },
          { label: 'Production/Hour', value: '$225', trend: '+12%', icon: Icons.TrendingUp },
          { label: 'Cancellation Rate', value: '12%', trend: '-3%', icon: Icons.XCircle },
        ].map((stat, index) => (
